...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    await sendAdminNotification(`👤 New Profile from ${full_name}`, profileAdmin(data), GROWTIVA_EMAIL_TO);
    await sendConfirmation(email, 'Profile received — Growtiva', profileConfirmation(data));
