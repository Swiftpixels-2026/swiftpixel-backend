...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    await sendAdminNotification(`✉️ New Growtiva Contact from ${name}`, contactAdmin(data), GROWTIVA_EMAIL_TO);
    await sendConfirmation(email, "We got your message — Growtiva", contactConfirmation(data));
