...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    await sendAdminNotification(`🔔 New Growtiva Subscriber: ${email}`, subscriberAdmin(data), GROWTIVA_EMAIL_TO);
    await sendConfirmation(email, 'Welcome to Growtiva! 🎉', subscriberConfirmation());
