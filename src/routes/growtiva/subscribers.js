...
const { subscriberAdmin, subscriberConfirmation } = require('../../services/growtiva/emailTemplates');
...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    await sendAdminNotification(`🔔 New Growtiva Subscriber: ${email}`, subscriberAdmin(data), GROWTIVA_EMAIL_TO, 'growtiva');
    await sendConfirmation(email, 'Welcome to Growtiva! 🎉', subscriberConfirmation(), 'growtiva');
